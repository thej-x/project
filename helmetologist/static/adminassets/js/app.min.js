      ...
      (m = oe.select =
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === u.length)) {
            ...
            for (
              r = $.needsContext.test(e) ? 0 : o.length;
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              ...
              ((i = r[s]).selected =
                -1 < E.inArray(E.valHooks.option.get(i), o)) && (n = !0);
  ...
  E.extend(E.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !u.noBubble && !m(n)) {
          for (
            a = u.delegateType || f, Mt.test(a + f) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            d.push(o), (s = o);
        ...
        g.hasContent
          ...
          : ((o = g.url.slice(h.length)),
            g.data &&
              ...
              ((h += (Ot.test(h) ? "&" : "?") + g.data), delete g.data),
            !1 === g.cache &&
              ((h = h.replace(zt, "$1")),
              (o = (Ot.test(h) ? "&" : "?") + "_=" + Dt++ + o)),
            (g.url = h + o)),
      ...
      xe =
        ...
        (we._dataApiKeydownHandler = function (e) {
          if (
            ...
            (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !p(this).hasClass(de))
          ) {
      ...
      (this.getDocumentScrollOffset = function () {
            ...
            if (
              ...
              x.zoom &&
                x.zoom.css({
                  top: t.top + 1,
                  left:
                    1 == x.rail.align ? t.left - 20 : t.left + x.rail.width + 4,
                }),
              x.railh && !x.railslocked)
            ) {
              (t = { top: i.top, left: i.left }),
                (n = _.railhoffset) &&
                  (n.top && (t.top += n.top), n.left && (t.left += n.left));
              var r = x.railh.align
                  ? t.top +
        ...
        (this.init = function () {
          ...
          if (
            ...
            x.ispage && (e = x.haswrapper ? x.win : x.doc),
              x.css(e, n),
              x.ispage && (b.isie11 || b.isie) && x.css(A("html"), n),
              !b.isios ||
                x.ispage ||
                x.haswrapper ||
                x.css(w, { "-webkit-overflow-scrolling": "touch" });
            ...
            if (
              ...
              i.css({ position: "fixed", top: 0, height: "100%" }),
                ...
                x.body.append(i),
                x.railh &&
                  (l.css({ position: "fixed", left: 0, width: "100%" }),
                  l.css(l.align ? { bottom: 0 } : { top: 0 }),
                  x.body.append(l));
            else {
              if (x.ishwscroll) {
                "static" == x.win.css("position") &&
                  x.css(x.win, { position: "relative" });
                ...
                x.isfixed || (x.viewport = x.getViewport(x.win[0])),
                  x.viewport &&
                    ...
                    /fixed|absolute/.test(x.viewport.css("position")) ||
                      x.css(x.viewport, { position: "relative" })),
                  i.css({ position: h }),
            ...
            if (
              (!1 === _.autohidemode
                ? ((x.autohidedom = !1),
                  x.rail.css({ opacity: _.cursoropacitymax }),
                  x.railh && x.railh.css({ opacity: _.cursoropacitymax }))
              ...
              (x.scrollmom = new F(x)),
                (x.ontouchstart = function (e) {
                  ...
                  if (
                    ((x.hasmoving = !1),
                    x.scrollmom.timer &&
                      (x.triggerScrollEnd(), x.scrollmom.stop()),
                    !x.railslocked)
                  ) {
                    var t = x.getTarget(e);
                ...
                if (
                  (x.railh &&
                    ...
                    x.ishwscroll && _.bouncescroll
                      ...
                      : (u < 0 && (a = u = 0),
                        u > x.page.maxw && ((u = x.page.maxw), (a = 0)))),
                  !x.hasmoving)
                ) {
                  if (
                  ...
                  if (!x.rail.drag || 3 == x.rail.drag.pt) {
                    ...
                    return (
                      ...
                      x.isiframe &&
                        ...
                        x.css(x.doc, { "pointer-events": "none" })),
                      x.cancelEvent(e)
                    );
                  }
                }),
            ...
            if (
              ...
              (x.onpreventclick = function (e) {
                ...
                (x.onclick =
                  ...
                  function (e) {
                    return (
                      !x.lastmouseup || ((x.lastmouseup = !1), x.cancelEvent(e))
                    );
                  }),
                _.grabcursorenabled &&
                  b.cursorgrabvalue &&
                  ...
                  x.css(x.rail, { cursor: b.cursorgrabvalue }));
            else {
              var d = function (e) {
                if (x.selectiondrag) {
                  if (e) {
              ...
              x.lazyResize(30),
                ...
                b.cantouch
                  ...
                  : _.emulatetouch &&
                    ...
                    _.grabcursorenabled &&
                      b.cursorgrabvalue &&
                      x.css(A(t.body), { cursor: b.cursorgrabvalue })),
        ...
        (this.showCursor = function (e, t) {
          if (
            ...
            if (
              (x.autohidedom &&
                (x.autohidedom.stop().css({ opacity: _.cursoropacitymax }),
                (x.cursoractive = !0)),
              ...
              ((x.hasmousefocus && "leave" === _.autohidemode) ||
                (x.cursortimeout = setTimeout(function () {
                  (x.rail.active && x.showonmouseevent) ||
                    (x.autohidedom
                      .stop()
                      .animate({ opacity: _.cursoropacitymin }),
                    x.zoom &&
                      x.zoom.stop().animate({ opacity: _.cursoropacitymin }),
                    (x.cursoractive = !1)),
                    (x.cursortimeout = 0);
                }, e || _.hidecursordelay))));
        }),
      ...
      (this.delegate = function (e, t, n, i, r) {
        ...
        (this._bind = function (e, t, n, i, r) {
          x.events.push({ e: e, n: t, f: n, b: i, q: !1 }),
            p && r
              ? e.addEventListener(t, n, { passive: !1, capture: i })
  ...
  (function (e, t) {
    ...
    function _(e) {
      w(this, e),
        ...
        !1 === Ze && ((Ze = !0), g.updateOffset(this), (Ze = !1));
    }
    function b(e) {
    ...
    (wn.add = dn),
      ...
      (wn.from = function (e, t) {
        return this.isValid() && ((b(e) && e.isValid()) || me(e).isValid())
          ? Ee({ to: this, from: e }).locale(this.locale()).humanize(!t)
      ...
      (wn.to = function (e, t) {
        return this.isValid() && ((b(e) && e.isValid()) || me(e).isValid())
          ? Ee({ from: this, to: e }).locale(this.locale()).humanize(!t)
          : this.localeData().invalidDate();
      }),
      (wn.toNow = function (e) {
        return this.to(me(), e);
            ...
            e.exports = function (e, t) {
              ...
              if ((n = l ? u : c ? u[a] || p(a, {}) : (u[a] || {}).prototype))
                for (i in t) {
                  if (
                    ((o = t[i]),
                    (r = e.noTargetGet ? (s = h(n, i)) && s.value : n[i]),
                    !g(l ? i : a + (c ? "." : "#") + i, e.forced) &&
                      void 0 !== r)
                  ) {
              ...
              Array.from(e).forEach(function (e) {
                return (function (e, t) {
                  ...
                  var s = u.default[o].toSvg(
                      l({}, i, r, { class: (0, c.default)(i.class, r.class) })
                    ),
                    a = new DOMParser()
